...
struct weights {
  ...
  static constexpr parameter_type shared_quantization_scale = static_cast<parameter_type>(1024);
  static constexpr parameter_type fc0_weight_quantization_scale = static_cast<parameter_type>(4096);
